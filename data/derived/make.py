...
### RUN SCRIPTS
tt.run_stata(PATHS, program='code/build.do')
tt.run_stata(PATHS, program='code/clean.do')
tt.run_stata(PATHS, program='code/compute.do')
tt.run_stata(PATHS, program='code/get_weather.do')
tt.run_stata(PATHS, program='code/label_vars.do')

...
### RUN SCRIPTS
tt.run_stata(PATHS, program='code/shift_level.do')
tt.run_stata(PATHS, program='code/clock_minute.do')
tt.run_stata(PATHS, program='code/compute_expectations_total.do')

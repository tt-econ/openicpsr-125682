...
### RUN SCRIPTS
tt.run_stata(PATHS, program='code/save_income_bins_total.do')
tt.run_stata(PATHS, program='code/save_ride_bins_total.do')
tt.run_stata(PATHS, program='code/save_dist_bins_total.do')
tt.run_stata(PATHS, program='code/save_controls.do')

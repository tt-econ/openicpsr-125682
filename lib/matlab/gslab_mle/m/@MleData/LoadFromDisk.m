...
%
% Loads MleData structure saved using SaveToDisk to an MleData object. 
%
% INPUTS
%
...
% OUTPUTS
%
%    - obj: MleData object loaded from [name].csv and [name].mat, contained in the specified directory.
%

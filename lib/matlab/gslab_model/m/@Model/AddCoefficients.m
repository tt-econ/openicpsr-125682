function [newlist indices] = AddCoefficients(paramlist, varlist, include_constant, prefix, suffix)
%
...
if include_constant
    coefflist = [coefflist [prefix 'constant']];
end
newlist = [paramlist coefflist];
indices = 1:length(coefflist);

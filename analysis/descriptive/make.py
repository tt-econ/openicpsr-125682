...
### RUN SCRIPTS
tt.run_stata(PATHS, program='code/appendixfigure4_prepare.do')
tt.run_r(PATHS, program='code/appendixfigure4.R')
tt.run_stata(PATHS, program='code/appendixfigure7.do')
tt.run_stata(PATHS, program='code/appendixfigure8.do')
tt.run_stata(PATHS, program='code/figure1.do')
tt.run_stata(PATHS, program='code/appendixtable1.do')
tt.run_stata(PATHS, program='code/appendixfigures1_2_3.do')

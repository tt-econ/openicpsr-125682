...
### RUN SCRIPTS
tt.run_stata(PATHS, program='code/appendixtables3_4.do')
tt.run_stata(PATHS, program='code/appendixfigure5_input.do')
tt.run_r(PATHS, program='code/appendixfigure5.R')
